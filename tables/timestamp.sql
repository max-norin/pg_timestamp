...
CREATE RULE "insert" AS ON INSERT TO "timestamp" DO INSTEAD NOTHING;
CREATE RULE "update" AS ON UPDATE TO "timestamp" DO INSTEAD NOTHING;
CREATE RULE "delete" AS ON DELETE TO "timestamp" DO INSTEAD NOTHING;
